...
- "I Delivered Enterprise Data Catalogs End-to-End. Here Is What I Learned." (2026): Lessons from leading two end-to-end catalog implementations. Alation (SaaS) at a government research agency: connected 13 systems, main challenges were system owner approvals (top-down from directors was faster) and cloud security briefings. OpenMetadata (open-source on ECS) at current company: 5 AWS accounts, 8000+ assets, challenges included OpenSearch version compatibility and managing Airflow ingestion scripts. Key learnings: adoption is hardest, top-down beats bottom-up, technical catalogs (Glue, Snowflake Horizon) suit AI/ML pipelines, business catalogs (Alation, OpenMetadata, DataHub) suit enterprise platforms. Covers data lineage and data contracts.
